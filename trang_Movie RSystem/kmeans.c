...
void kmeans(int dim,double *X,int n,int k,double *cluster_centroid,int *cluster_assignment_final) // dimension of data,pointer to data,number of elements,number of clusters,initial cluster,output centroids	   
{
